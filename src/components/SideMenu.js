...
const SideMenu = ()=>{
    ...
    const selector= useSelector((store)=>store.menuToggle);
    console.log(selector);

    return (
        <div>
           <div className="px-4 py-2 rounded-2xl my-2 hover:bg-gray-400 cursor-pointer"><span className=""> <i className="fa-solid fa-house text"></i>{selector && "Home"}</span></div>
